...
export type LaunchesPastQuery = { __typename?: 'Query', launchesPast?: Maybe<Array<Maybe<{ __typename?: 'Launch', id?: Maybe<string>, mission_name?: Maybe<string>, launch_date_local?: Maybe<any> }>>> };
 ...
 *
 * To use a Smart Query within a Vue component, call `useLaunchesPastQuery` as the value for a query key
 ...
 * {
 *   apollo: {
 *     launchesPast: useLaunchesPastQuery({
 *       variables: {
 ...
 * }
 */
export const useLaunchesPastQuery = createSmartQueryOptionsFunction<
  LaunchesPastQuery,
